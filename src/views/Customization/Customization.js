              ...
              <Row style={{ margin: '0px 5px' }}>
                ...
                <Col xs={10} lg='4' style={{ margin: 'auto' }}>
                  <FormGroup>
                    ...
                    <Select
                      onChange={(e) => setTypography({ ...typography, fontWeight: e.value })}
                      name='fontWeight'
                      className='form-control-alternative'
                ...
                <Col xs={10} lg='2' style={{ margin: 'auto' }}>
                  <FormGroup>
                    ...
                    <Select
                      onChange={(e) => setTypography({ ...typography, fontSize: e.value })}
                      name='hospitals'
                      className='form-control-alternative'
            ...
            <Card className='shadow' style={{ margin: '10px 0px' }}>
              <Row>
                <Col xs={10} lg='2' style={{ margin: '10px 50px' }}>
                  <h4 style={{ fontWeight: '600', margin: '5px 10px' }}> Background Image</h4>
                </Col>
              </Row>
